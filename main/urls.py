...
urlpatterns = [
    ...
    path('image/<int:post_id>', views.ViewImage.as_view(), name='image'),
    path('image/rate/', views.ViewImage.rate_image, name="rate-view"),
    path('auction/<int:post_id>', views.ViewAction.as_view(), name="auction"),
]